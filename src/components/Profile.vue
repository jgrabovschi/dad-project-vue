...
<template>
    <Card class="w-[450px] mx-auto my-8 p-8 bg-white dark:bg-gray-800 border-0">
        ...
        <RouterLink :to="{ name: 'removeAccount' }" class="w-40 mx-auto py-2 bg-red-600 text-white rounded hover:bg-red-700 transition flex items-center justify-center space-x-2">
