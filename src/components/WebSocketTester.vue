...
<template>
    <Card class="w-[450px] mx-auto my-8 p-4 px-8 bg-white dark:bg-gray-800 border-0">
        ...
        <div class="max-w-2xl mx-auto py-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-6 dark:text-white">WebSocket Tester</h2>
            ...
            <div class="mb-6 flex items-center space-x-2">
                <div class="flex items-center">
                    ...
                    <span class="text-sm text-gray-600 dark:text-white"> {{ (!socket.connected) ? 'Not' : '' }} Connected</span>
                </div>
            </div>
